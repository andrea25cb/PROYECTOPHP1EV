...
$cookie_expiration_time = $current_time + (60 * 24 * 3);  // for 3 days
...
// Check if loggedin session exists
else if (! empty($_COOKIE["correo"]) && ! empty($_COOKIE["random_password"]) && ! empty($_COOKIE["random_selector"])) {
    ...
    $userToken = $auth->getTokenByUsername($_COOKIE["correo"],0);
